      ...
      {petitionUrl && (
        <div className="mt-4 rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
          ...
          <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-start">
            ...
            {/* Social icon buttons — 5 in one row */}
            <div className="flex justify-between gap-1">
              ...
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 bg-zinc-100 transition hover:bg-zinc-200 dark:border-neutral-700 dark:bg-neutral-700">
                  {copied ? (
                ...
                <span className="text-[9px] font-medium text-zinc-600 dark:text-neutral-400">{copied ? 'Copied!' : 'Copy'}</span>
              </button>
              ...
              <a
                ...
                className="flex flex-1 flex-col items-center gap-1.5"
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#1877F2] transition hover:opacity-90">
                  <svg className="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </span>
                <span className="text-[9px] font-medium text-zinc-600 dark:text-neutral-400">Facebook</span>
              </a>
              ...
              <a
                ...
                className="flex flex-1 flex-col items-center gap-1.5"
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366] transition hover:opacity-90">
                  <svg className="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-[9px] font-medium text-zinc-600 dark:text-neutral-400">WhatsApp</span>
              </a>
              ...
              <a
                ...
                className="flex flex-1 flex-col items-center gap-1.5"
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-zinc-900 transition hover:opacity-90 dark:bg-zinc-700">
                  <svg className="h-3.5 w-3.5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </span>
                <span className="text-[9px] font-medium text-zinc-600 dark:text-neutral-400">X</span>
              </a>
              ...
              >
                ...
                <span className="text-[9px] font-medium text-zinc-600 dark:text-neutral-400">Email</span>
              </a>
            </div>
