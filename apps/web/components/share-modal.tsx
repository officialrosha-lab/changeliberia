  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-5">
        <h3 className="text-lg font-semibold">Share this petition now</h3>
        <p className="mt-1 text-sm text-zinc-600">Your share brings more verified voices.</p>
        
        {/* Reach estimate badge */}
        <div className="mt-3 inline-block rounded-full bg-blue-100 px-3 py-1 text-xs font-semibold text-blue-700">
        ...
        {activeChallenge && (
          <div className="mt-3 rounded-lg bg-purple-50 p-3">
            <div className="flex items-center justify-between text-xs font-semibold">
              <span className="text-purple-700">{activeChallenge.title}</span>
              <span className="text-purple-600">{challengeProgress}%</span>
            </div>
            <div className="mt-1.5 h-2 rounded-full bg-purple-200">
              <div 
        ...
        <div className="mt-4 grid gap-2">
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="rounded-xl bg-emerald-600 px-4 py-3 text-center font-semibold text-white hover:bg-emerald-700 transition"
          >
            WhatsApp
          </a>
          ...
          <button 
            ...
            className="rounded-xl bg-blue-600 px-4 py-3 text-center font-semibold text-white hover:bg-blue-700 transition"
          >
            Facebook
          </button>
          ...
          <button 
            ...
            className="rounded-xl border border-zinc-300 px-4 py-3 font-semibold hover:bg-zinc-50 transition"
          >
